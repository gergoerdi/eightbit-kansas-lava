...
proc add_source_files {} {
   ...
   if { ! [ file exists "ipcore_dir/ClockMan.vhd" ] } {
       puts "$myScript: Regenerating ClockMan"
       cd ipcore_dir
       run_cg_regen "ClockMan" xc6slx9-2tqg144 VHDL CURRENT
       cd ..
   }
   
   puts "$myScript: Adding sources to project..."

   xfile add "gensrc/MainBoard.vhdl"
   xfile add "gensrc/Video.vhdl"
   xfile add "gensrc/lava-prelude.vhdl"
   xfile add "ipcore_dir/ClockMan.xco"
   xfile add "src/DualRAM.vhdl"
   xfile add "src/PET.ucf"
   xfile add "src/PET.vhdl"
   xfile add "src/ToggleSync.vhdl"

   # Set the Top Module as well...
   project set top "rtl" "PET"
